...
description: "Visão estrutural das fronteiras do sistema e do racional arquitetural do projeto."
version: "v1"
...
Um motor em **.NET 9** que usa **Semantic Kernel** para coordenar múltiplas estratégias de LLM e regras de governança.
