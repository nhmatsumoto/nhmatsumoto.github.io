        ...
        if stripped.startswith("```"):
            ...
            if language == "mermaid":
                ...
                parts.append(
                    ...
                    f'    <div class="code-shell-actions">'
                    ...
                    f'    </div>'
                    f'    <div class="code-shell-controls" aria-hidden="true"><span class="control-dot minimize"></span><span class="control-dot maximize"></span><span class="control-dot close"></span></div>'
                    f'  </div>'
